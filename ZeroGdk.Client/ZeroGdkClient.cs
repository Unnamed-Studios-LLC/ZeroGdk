...
namespace ZeroGdk.Client
{
	...
	public sealed class ZeroGdkClient : IDisposable
	{
		...
		/// </summary>
		/// <param name="options">The connection options for configuring the network client.</param>
		/// <param name="encoding">The data encoding used for serialization and deserialization.</param>
		public ZeroGdkClient(ConnectionOptions options, DataEncoding encoding)
		{
			_options = options;
			_encoding = encoding;
