...
{
    /// <summary>
    ///     Ensures the capacity of the <see cref="Entities.EntityInfo"/>.
    /// </summary>
    /// <param name="world">The <see cref="Entities"/>.</param>
    /// <param name="capacity">The new capacity.</param>
    public static void EnsureCapacity(this Entities world, int capacity)
    {
    ...
    /// </summary>
    /// <param name="world">The <see cref="Entities"/> instance.</param>
    /// /// <returns>a tuple (id, version) list of the recycled entities.</returns>
    public static List<(int, int)> GetRecycledEntityIds(this Entities world)
    {
    ...
    public static void SetRecycledEntityIds(this Entities world, List<(int, int)> recycledEntities)
    {
    ...
    /// <summary>
    ///     Returns the <see cref="EntityInfoStorage.EntityData"/> of a <see cref="Entities"/> for reading or modifiyng it.
    /// </summary>
    /// <param name="world">The <see cref="Entities"/> instance.</param>
    /// <returns>Its <see cref="EntityInfoStorage.EntityData"/> array.</returns>
    public static JaggedArray<EntityData> GetEntityDataArray(this Entities world)
    {
    ...
    /// <summary>
    ///     Sets the <see cref="EntityInfoStorage.EntityData"/> of a <see cref="Entities"/>.
    /// </summary>
    /// <param name="world">The <see cref="Entities"/> instance.</param>
    /// <param name="slots">The new slots array.</param>
    public static void SetEntityDataArray(this Entities world, JaggedArray<EntityData> slots)
    {
        world.EntityInfo.EntityData = slots;
    }

    /// <summary>
    ///     Sets the <see cref="Entities.Archetypes"/>.
    /// </summary>
    /// <param name="world">The <see cref="Entities"/> instance.</param>
    /// <param name="archetypes">The new list of <see cref="Archetype"/>s.</param>
    public static void SetArchetypes(this Entities world, List<Archetype> archetypes)
    {
    ...
    public static void SetArchetype(this Entities world, Entity entity, Archetype archetype)
    {
    ...
    public static Slot GetSlot(this Entities world, Entity entity)
    {
    ...
    /// <param name="entity">The <see cref="Entity"/>.</param>
    /// <returns>The <see cref="Slot"/> as a <see cref="ValueTuple{T,TT}"/>.</returns>
    public static void SetSlot(this Entities world, Entity entity, Slot slot)
    {
