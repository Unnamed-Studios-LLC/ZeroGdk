...
namespace ZeroGdk.Server
{
	public sealed class World
	{
		...
		/// <summary>
		/// The maximum maount of connections that can be added to this world, <c>-1</c> for no limit.
		/// </summary>
		public int MaxConnections { get; private set; } = -1;

		/// <summary>
		/// A list of all connections in the world
		/// </summary>
		...
		/// Persistent data is sent to connections when they first observe the entity or when the data changes.
		/// </summary>
		/// <typeparam name="T">The unmanaged data type being pushed.</typeparam>
		/// <param name="entity">The target entity.</param>
		...
		*/
		...
		/// <summary>
		/// Sets persistent data for the specified entity without triggering any update to network connections.
		...
		/// <summary>
		/// Sets a span of persistent data for the specified entity without pushing updates to connections.
